defmodule WorkingTimeManagerWeb.WorkingTimeControllerTest do
  use WorkingTimeManagerWeb.ConnCase
  ...
  def fixture(:working_time) do
    {:ok, working_time} = Resource.create_working_time(@create_attrs)
    working_time
  end
